...
public class LineComparisonUC3 {
	...
	private static void checkingEqualsLine(double length1, double length2) {
		...
		if (a > b) {
			System.out.println("Lenght of first line is greater then lenght of second line");
		} else if (a < b) {
			System.out.println("Lenght of second line is greater then lenght of first line");
		} else if (a == b) {
